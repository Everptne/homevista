  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto p-0">
        <button
          onClick={onClose}
          className="absolute right-6 top-6 z-20 bg-white/80 backdrop-blur-md p-3 rounded-full shadow-lg hover:scale-110 transition-all"
        >
          ...
          <div className="md:col-span-2 p-8 space-y-6">
            <DialogHeader>
              <div className="space-y-2">
                <span
                  className="inline-block text-xs font-medium px-3 py-1 rounded-full bg-primary/10 text-primary"
                ...
                <div className="flex items-center gap-2 text-muted-foreground">
                  ...
                  <span className="text-sm" data-testid="text-modal-zone">
                    {property.zone}
                  </span>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                <Button
                  ...
                  onClick={() =>
                    console.log(
                      "Call button clicked for property:",
                      property.id,
                    )
                  }
                ...
                <Button
                  ...
                  onClick={() =>
                    console.log(
                      "Email button clicked for property:",
                      property.id,
                    )
                  }
